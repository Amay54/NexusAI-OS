"""
NexusAI OS FastAPI Control Plane Entrypoint (v0.3.3).
Registers Auth, Workflows, MCP Tools, Memory, Explainability, Knowledge Graph, Reflection, History, Snapshots, Observability, Workforce, Dynamic Org, Executive, and Explainable Intelligence.
"""
...
app = FastAPI(
    ...
    description="NexusAI OS Enterprise Control Plane & Explainable Executive Intelligence API",
    version="0.3.3",
    lifespan=lifespan
)
